...
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie } from "/home/project/node_modules/h3/dist/index.mjs";
...
import { klona } from "/home/project/node_modules/klona/dist/index.mjs";
import destr, { destr as destr$1 } from "/home/project/node_modules/destr/dist/index.mjs";
import { deepPickUnsafe, deepOmitUnsafe } from "deep-pick-omit";
import { parse } from "/home/project/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import { isEqual } from "/home/project/node_modules/ohash/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-Cgi5iY9c.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/login-C7co-Vuo.js")
  },
  {
    name: "tables",
    path: "/tables",
    component: () => import("./_nuxt/tables-D-MANlL0.js")
  },
  {
    name: "history",
    path: "/history",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/history-8jirHT6z.js")
  },
  {
    name: "waiters",
    path: "/waiters",
    component: () => import("./_nuxt/waiters-BcnnUFuP.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/products-8DsIbCoe.js")
  },
  {
    name: "categories",
    path: "/categories",
    meta: { "middleware": "auth" },
    component: () => import("./_nuxt/categories-OIqDdZ17.js")
  },
  {
    name: "restaurant",
    path: "/restaurant",
    component: () => import("./_nuxt/restaurant-nZ87dc-H.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-BFdZOGzI.js")
};
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-D0Vqu4QZ.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-BJViuNik.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-D5hOfwna.js"));
