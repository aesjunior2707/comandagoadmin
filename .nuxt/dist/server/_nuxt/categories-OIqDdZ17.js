...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex justify-between items-center mb-8"><div><h1 class="text-3xl font-bold text-gray-900 mb-2">Gestão de Categorias</h1><p class="text-gray-600">Organize os itens do seu cardápio em categorias.</p></div><button class="btn-primary">`);
...
//# sourceMappingURL=categories-OIqDdZ17.js.map
