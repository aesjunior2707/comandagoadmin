import { _ as __nuxt_component_0 } from "./nuxt-link-GnlWUqLn.js";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "space-y-8" }, _attrs))}><div class="flex flex-col sm:flex-row sm:items-center sm:justify-between"><div><h1 class="text-3xl font-bold text-gray-900">Dashboard</h1><p class="mt-2 text-gray-600">Bem-vindo de volta, ${ssrInterpolate((_a = unref(authStore).user) == null ? void 0 : _a.name)}. Veja o que está acontecendo no ${ssrInterpolate((_c = (_b = unref(authStore).user) == null ? void 0 : _b.restaurant) == null ? void 0 : _c.name)} hoje.</p></div><div class="mt-4 sm:mt-0 flex space-x-3"><button${ssrIncludeBooleanAttr(unref(dashboardStore).isLoading) ? " disabled" : ""} class="btn-secondary">`);
      ...
      _push(`</div></div><div class="card"><div class="card-header"><h3 class="text-lg font-semibold text-gray-900">Ações Rápidas</h3></div><div class="card-body"><div class="grid grid-cols-2 gap-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/products",
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<span class="text-xs font-medium"${_scopeId}>Adicionar Garçom</span>`);
          } else {
            return [
              createVNode(unref(UserPlusIcon), { class: "w-6 h-6 text-blue-600" }),
              createVNode("span", { class: "text-xs font-medium" }, "Adicionar Garçom")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-Cgi5iY9c.js.map
