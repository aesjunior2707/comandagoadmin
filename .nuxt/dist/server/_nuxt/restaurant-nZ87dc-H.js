...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</button></div></form></div></div><div class="space-y-6"><div class="card"><h3 class="text-lg font-semibold text-gray-900 mb-6">Estatísticas do Restaurante</h3><div class="space-y-4"><div class="flex justify-between items-center"><span class="text-gray-600">Total de Mesas</span><span class="font-semibold text-gray-900">${ssrInterpolate(unref(restaurantStore).restaurantStats.totalTables)}</span></div><div class="flex justify-between items-center"><span class="text-gray-600">Total de Produtos</span><span class="font-semibold text-gray-900">${ssrInterpolate(unref(restaurantStore).restaurantStats.totalProducts)}</span></div><div class="flex justify-between items-center"><span class="text-gray-600">Total de Garçons</span><span class="font-semibold text-gray-900">${ssrInterpolate(unref(restaurantStore).restaurantStats.totalWaiters)}</span></div><div class="flex justify-between items-center"><span class="text-gray-600">Total de Pedidos no Mês</span><span class="font-semibold text-gray-900">${ssrInterpolate(unref(restaurantStore).restaurantStats.monthlyOrders.toLocaleString())}</span></div></div></div></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=restaurant-nZ87dc-H.js.map
