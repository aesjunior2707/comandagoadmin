...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex justify-between items-center mb-8"><div><h1 class="text-3xl font-bold text-gray-900 mb-2">Histórico de Mesas e Contas</h1><p class="text-gray-600">Ver histórico de pedidos e gerenciar contas de clientes</p></div><div class="flex gap-3"><button class="btn-secondary">`);
      ...
      _push(`<!--]--></select></div><div class="form-group"><label class="block text-sm font-medium text-gray-700 mb-2">Garçons</label><select class="input-field"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(selectedWaiter)) ? ssrLooseContain(unref(selectedWaiter), "") : ssrLooseEqual(unref(selectedWaiter), "")) ? " selected" : ""}>All Waiters</option><!--[-->`);
...
//# sourceMappingURL=history-8jirHT6z.js.map
