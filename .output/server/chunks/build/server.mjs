...
const _routes = [
  {
    ...
    component: () => import('./index-Cgi5iY9c.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-C7co-Vuo.mjs')
  },
  {
    name: "tables",
    path: "/tables",
    component: () => import('./tables-D-MANlL0.mjs')
  },
  {
    name: "history",
    path: "/history",
    meta: { "middleware": "auth" },
    component: () => import('./history-8jirHT6z.mjs')
  },
  {
    name: "waiters",
    path: "/waiters",
    component: () => import('./waiters-BcnnUFuP.mjs')
  },
  {
    name: "products",
    path: "/products",
    component: () => import('./products-8DsIbCoe.mjs')
  },
  {
    name: "categories",
    path: "/categories",
    meta: { "middleware": "auth" },
    component: () => import('./categories-OIqDdZ17.mjs')
  },
  {
    name: "restaurant",
    path: "/restaurant",
    component: () => import('./restaurant-nZ87dc-H.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-D0Vqu4QZ.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BJViuNik.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D5hOfwna.mjs'));
...
export { _export_sfc as _, defineNuxtRouteMiddleware as a, useRouter as b, useNuxtApp as c, defineStore as d, entry$1 as default, useRuntimeConfig as e, nuxtLinkDefaults as f, navigateTo as n, persistedState as p, resolveRouteObject as r, tryUseNuxtApp as t, useRoute as u };
