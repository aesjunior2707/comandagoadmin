...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex justify-between items-center mb-8"><div><h1 class="text-3xl font-bold text-gray-900 mb-2">Gest\xE3o de Gar\xE7ons</h1><p class="text-gray-600"> Gerencie a equipe do seu restaurante e o desempenho deles. </p></div><button class="btn-primary">`);
      _push(ssrRenderComponent(unref(PlusIcon), { class: "w-4 h-4 mr-2" }, null, _parent));
      _push(` Adicionar Gar\xE7om </button></div><div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8"><div class="card"><div class="flex items-center space-x-4"><div class="p-3 bg-blue-100 rounded-lg">`);
      _push(ssrRenderComponent(unref(UsersIcon), { class: "w-6 h-6 text-blue-600" }, null, _parent));
      _push(`</div><div><p class="text-sm font-medium text-gray-600 mb-1"> Total de Gar\xE7ons </p><p class="text-2xl font-bold text-gray-900">${ssrInterpolate(unref(waitersStore).totalWaiters)}</p></div></div></div><div class="card"><div class="flex items-center space-x-4"><div class="p-3 bg-green-100 rounded-lg">`);
      _push(ssrRenderComponent(unref(CheckCircleIcon), { class: "w-6 h-6 text-green-600" }, null, _parent));
      _push(`</div><div><p class="text-sm font-medium text-gray-600 mb-1"> Em Servi\xE7o </p><p class="text-2xl font-bold text-gray-900">${ssrInterpolate(unref(waitersStore).waiterStatusCounts.onDuty)}</p></div></div></div></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"><!--[-->`);
...
//# sourceMappingURL=waiters-BcnnUFuP.mjs.map
