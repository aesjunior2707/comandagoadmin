...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex justify-between items-center mb-8"><div><h1 class="text-3xl font-bold text-gray-900 mb-2">Gest\xE3o de Produtos</h1><p class="text-gray-600">Gerencie os itens do seu card\xE1pio e cat\xE1logo de produtos.</p></div><button class="btn-primary">`);
...
//# sourceMappingURL=products-8DsIbCoe.mjs.map
