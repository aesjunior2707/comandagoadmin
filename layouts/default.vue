        ...
        <div class="flex flex-col h-full">
          ...
          <div class="p-4 border-b border-gray-200 bg-gray-50">
            <div class="flex items-center">
              <img :src="authStore.user?.avatar" :alt="authStore.user?.name" class="h-10 w-10 rounded-full object-cover">
              <div class="ml-3">
                <p class="text-sm font-medium text-gray-900">{{ authStore.user?.name }}</p>
                <p class="text-xs text-gray-500">{{ authStore.user?.restaurant?.name }}</p>
              </div>
            </div>
          </div>
          ...
          <div class="p-4 border-t border-gray-200">
            <button @click="handleLogout" class="w-full nav-link text-red-600 hover:text-red-700 hover:bg-red-50">
        ...
        <div class="flex items-center justify-between h-16 px-4 lg:px-6">
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="relative" ref="userMenuRef">
              ...
              >
                <img :src="authStore.user?.avatar" :alt="authStore.user?.name" class="h-8 w-8 rounded-full object-cover">
                <span class="hidden md:block font-medium text-gray-700">{{ authStore.user?.name }}</span>
